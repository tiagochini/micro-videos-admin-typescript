import { SearchParams } from "#Shared/Domain/Repository/repository-contracts";
...
export namespace ListCategoryUseCase {
    export class UseCase implements UseCaseContract<ListCategoryInputDto, ListCategoryOutputDto> {
